...
interface IPolygonConstructorItemProps {
...
const PolygonConstructorItem = ({
  constructorItem,
  isSelected,
  onSelect,
  onChange,
}: IPolygonConstructorItemProps) => {
...
export default PolygonConstructorItem;
